...
console.log("All products:", products.content); 
  ...
  const handleFilter = (value, sectionId) => {
    ...
    if (valueExists) {
      ...
      // If no values left, remove the whole filter key
  ...
  // this filter handler funtion will handle the filter logic for single radio button only.
  // It will update the URL with the selected value for the given sectionId.
  const handleSingleFilter = (value, sectionId) => {
    const searchParams = new URLSearchParams(location.search);

    // Get current filter value for the section
                    ...
                    <DisclosurePanel className="pt-6">
                      <FormControl component="fieldset">
                          <RadioGroup
                            ...
                            defaultValue=""
                             onChange={(e) => handleSingleFilter(e.target.value, section.id)}
                          >
